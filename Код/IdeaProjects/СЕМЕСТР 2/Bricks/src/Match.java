...
class Match {
    ...
    public Match() {
        ...
        _lib = new Image[4];//_lib = new Image[3];
        _lib[0] = _pf.getToolkit().getImage("src/puck.gif");
        _lib[1] = _pf.getToolkit().getImage("src/puddle.gif");
        _lib[2] = _pf.getToolkit().getImage("src/brick.gif");
        _lib[3] = _pf.getToolkit().getImage("src/hard_brick.gif");
    ...
    public void start() {
        ...
        _bp = new BrickPile(_pf, _lib[2], _lib[3]); //_bp = new BrickPile(_pf, _lib[2], _lib[3]);
